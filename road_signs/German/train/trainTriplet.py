...
from road_signs.German.dataset.GermanTrafficSignDatasetTripletOnline import GermanTrafficSignDatasetTriplet
...
if __name__ == '__main__':
    train_loader = DataLoader(GermanTrafficSignDatasetTriplet(train=True), batch_size=BS, shuffle=True, pin_memory=bool(os.getenv('USE_LAB')))
    test_loader = DataLoader(GermanTrafficSignDatasetTriplet(train=False), batch_size=BS, shuffle=True, pin_memory=bool(os.getenv('USE_LAB')))
    ...
    torch.save(model.state_dict(), '../../weights/German/triplet.pth')
